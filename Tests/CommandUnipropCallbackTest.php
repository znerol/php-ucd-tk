...
class CommandUnipropCallbackTest extends PHPUnit_Framework_TestCase
{
  private $runner;
  ...
  public function testParsePropListData() {
    $command = new Command\UnipropCallback($this->reader,
      function($start, $end, $fields, $comment) {
        return array('TESTPROP' => $fields[1]);   
      },
      function($start, $end, $fields, $comment) {
        return $comment;
      }
  ...
  public function testParseWithCustomComment() {
    $command = new Command\UnipropCallback($this->reader,
      function($start, $end, $fields, $comment) {
        return array('OTHERPROP' => $fields[1]);   
      },
      function($start, $end, $fields, $comment) {
        return 'COMMENT: property value is ' . $fields[1];
      }
    );
    ...
    $expected = array(
      //          $head,  $next,  $props,                              $comment
      new Uniprop(0x0009, 0x000E, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),
      new Uniprop(0x0020, 0x0021, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),
      new Uniprop(0x0085, 0x0086, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),
      new Uniprop(0x00A0, 0x00A1, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),
      new Uniprop(0x1680, 0x1681, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),
      new Uniprop(0x180E, 0x180F, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),
      new Uniprop(0x2000, 0x200B, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),

      // Despite being adjacent the following two lines do not get merged 
      // because the property value differs.
      new Uniprop(0x200C, 0x200E, array('OTHERPROP' => 'Join_Control'), 'COMMENT: property value is Join_Control'),
      new Uniprop(0x200E, 0x2010, array('OTHERPROP' => 'Bidi_Control'), 'COMMENT: property value is Bidi_Control'),
      ...
      new Uniprop(0x2028, 0x202A, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),

      new Uniprop(0x202A, 0x202F, array('OTHERPROP' => 'Bidi_Control'), 'COMMENT: property value is Bidi_Control'),
      new Uniprop(0x202F, 0x2030, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),
      new Uniprop(0x205F, 0x2060, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),
      new Uniprop(0x3000, 0x3001, array('OTHERPROP' => 'White_Space'),  'COMMENT: property value is White_Space'),
    );
